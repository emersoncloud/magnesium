      ...
      >
        ...
        >
          {bestSendGrade && (
            ...
            >
              <div style={{ display: 'flex', fontSize: 42, fontWeight: 900, lineHeight: 1 }}>{bestSendGrade}</div>
              <div style={{ display: 'flex', fontSize: 14, letterSpacing: '0.1em', marginTop: 4 }}>BEST SEND</div>
            </div>
          )}
          {bestFlashGrade && (
            <div
            ...
            >
              <div style={{ display: 'flex', fontSize: 42, fontWeight: 900, lineHeight: 1 }}>{bestFlashGrade}</div>
              <div style={{ display: 'flex', fontSize: 14, letterSpacing: '0.1em', marginTop: 4 }}>BEST FLASH</div>
            </div>
          )}
        </div>
