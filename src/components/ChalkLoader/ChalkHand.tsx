...
export function ChalkHand({ side, scale = 1, className }: ChalkHandProps) {
  ...
  return (
    ...
    >
      ...
      <polygon points="15,35 65,30 70,75 10,80" className="fill-slate-900" />

      {/* Index finger - angular shard */}
      <polygon points="18,35 28,33 32,8 16,10" className="fill-slate-900" />

      {/* Middle finger - tallest shard */}
      <polygon points="30,32 42,30 46,2 28,4" className="fill-slate-900" />

      {/* Ring finger - angular shard */}
      <polygon points="44,30 56,32 62,10 48,6" className="fill-slate-900" />

      {/* Pinky finger - smaller angular shard */}
      <polygon points="58,34 68,38 76,18 64,12" className="fill-slate-900" />

      {/* Thumb - angled outward */}
      <polygon points="10,45 18,55 6,72 0,58" className="fill-slate-900" />
      ...
      <line x1="15" y1="35" x2="65" y2="30" stroke="white" strokeWidth="1.5" opacity="0.25" />
